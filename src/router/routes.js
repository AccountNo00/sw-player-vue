...
export default [
  ...
  // },
  {
    ...
    component: () => import("./views/_player/home"),
  },
  {
    path: "/login",
    name: "login",
  ...
  // TELEGRAM
  {
    ...
    component: () => import("./views/_auth/register"),
  },
  // PLAYER
  
  {
    ...
    component: () => import("./views/_history/bet"),
  },
  {
    ...
    component: () => import("./views/_history/transaction"),
  },
  {
    path: "/history/points",
    name: "history-points",
    ...
    component: () => import("./views/_history/points"),
  },
  // TRANSACTION
  {
    ...
    component: () => import("./views/_transaction/deposit"),
  },
  {
    ...
    component: () => import("./views/_transaction/withdraw"),
  },
  // SETTINGS
  
  {
    ...
    component: () => import("./views/_settings/message"),
  },
  {
    path: "/message-create",
    name: "message-create",
    ...
    component: () => import("./views/_settings/message-create"),
  },
  // PROFILE
  {
    path: "/profile",
    ...
    component: () => import("./views/_settings/profile"),
  },
  // CHANGE PASSWORD
  
  {
    ...
    component: () => import("./views/_settings/change-password"),
  },
];
